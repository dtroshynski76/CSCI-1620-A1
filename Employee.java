...
//Partners: NONE
//This assignment will create a simple class hierarchy built upon the Employee example discussed in class. It will use inheritance to create and output a data set of employees including their name, unique ID number, gender, pay rate, and whether or not they are full time employees or not.
