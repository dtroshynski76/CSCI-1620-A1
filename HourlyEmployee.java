...
//Partners: NONE
// This program will create a simple class hierarchy built upon the Employee example used in class. It will create and output examples of employees with info such as their name, gender, unique ID number, wage, and how often they work(be it hours worked or just salary).
